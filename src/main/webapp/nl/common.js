    ...
    $.ajax(BIGSERVER + 'request-attrs', {
        ...
        .fail(function(jqXhr, textStatus) {
            ...
            if (errormsg === 'error:no-results') {
                requestEnd('danger', 'Geen registratie gevonden in het BIG register', message);
            } else {
                requestEnd('danger', 'De credentials kunnen niet aan de backend server gevraagd worden', message);
            }
        });
}
