...
function failure(msg) {
    ...
    (_console = console).log.apply(_console, ["ERROR:", msg].concat(data));
    ...
    if (typeof failureCallback !== "undefined") {
        failureCallback.apply(undefined, [msg].concat(data));
    }
}
...
function verify(request, success_cb, cancel_cb, failure_cb) {
    ...
    if ((typeof request === "undefined" ? "undefined" : _typeof(request)) === "object") {
        console.log("WARNING: calling IRMA.verify with a bare service provider request " + "is deprecated, you should pass a JWT instead. For now your request will be " + "converted to an unsigned JWT, but you should consider doing this yourself " + "(e.g. using IRMA.createUnsignedVerificationJWT).");
...
function setAndCheckCallbacks(success_cb, cancel_cb, failure_cb) {
    ...
    if (typeof successCallback !== "function") {
        console.log("WARNING: successCallback is not defined.", "irma.js will not return any results!");
        successCallback = function successCallback() {};
    }

    if (typeof cancelCallback !== "function") {
        console.log("WARNING: cancelCallback is not defined.", "irma.js will not notify cancel events!");
        cancelCallback = function cancelCallback() {};
    }

    if (typeof failureCallback !== "function") {
        console.log("WARNING: failureCallback is not defined.", "irma.js will not notify error events!");
...
function showPopup() {
    if (ua === UserAgent.Desktop) {
        ...
        var serverPage;
        if (action === Action.Issuing) serverPage = "issue.html";else if (action === Action.Verifying) serverPage = "verify.html";else serverPage = "sign.html";

        // Add modal iframe
        $("<div id='irma-server-modal' class='modal fade' tabindex='-1' role='dialog' aria-hidden='true'>" + "<div class='modal-dialog'><div class='modal-content'><div class='modal-body'>" + "<iframe frameborder='0' allowfullscreen=''></iframe>" + "</div></div></div></div>").appendTo("body");
...
function connectClientToken() {
    ...
    if (ua === UserAgent.Android) {
        ...
        var newUrl = "intent://#Intent;package=org.irmacard.cardemu;scheme=cardemu;" + "l.timestamp=" + Date.now() + ";" + "S.qr=" + encodeURIComponent(JSON.stringify(sessionPackage)) + ";" + "S.browser_fallback_url=http%3A%2F%2Fapp.irmacard.org%2Fverify;end";
...
function createUnsignedJWT(iprequest) {
    console.log("WARNING: this function is deprecated and may be removed in later " + "versions. Use IRMA.createUnsignedIssuanceJWT instead.");
...
},{"bootstrap":2,"jwt-decode":16}],2:[function(require,module,exports){
...
},{"Base64":18}],16:[function(require,module,exports){
'use strict';
...
},{"./base64_url_decode":15,"./json_parse":17}],17:[function(require,module,exports){
module.exports = function (str) {
  var parsed;
